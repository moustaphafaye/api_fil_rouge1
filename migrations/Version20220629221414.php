 ...
 */
final class Version20220629221414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD client_id INT DEFAULT NULL, ADD gestionnaire_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP client_id, DROP gestionnaire_id');
    }
}
